...
TossResult <- rbinom(200000000, dice, (1/6))
head(TossResult)
tosstable <- table(TossResult)
tosstable

plot(tosstable)

tosstable <- data.frame(table(TossResult))
tosstable$TossResult <- as.integer(as.character(tosstable$TossResult))
...
[Throwing dice - theory](http://gwydir.demon.co.uk/jo/probability/calcdice.htm)

[A Collection of Dice Problems (by Matthew M. Conroy)](http://www.madandmoonly.com/doctormatt/mathematics/dice1.pdf)

[Probability (a collection of examples and problems by Neil E. Cotter)](http://www.ece.utah.edu/eceCTools/Probability/_Probability.htm)
