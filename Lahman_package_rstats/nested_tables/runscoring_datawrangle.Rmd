...
Here's a speed test comparison, using my home PC:
...
- the data table "Teams" is sourced from the baseballdatabank on github https://github.com/chadwickbureau/baseballdatabank))
...
- and then creates a nested data table, following the `group_by()` year and league (`lgID`)
